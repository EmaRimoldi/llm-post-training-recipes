...
Training code is grouped by recipe rather than chronology.

## Subfolders

- `sft/`: supervised fine-tuning recipes;
- `mcqa/`: multiple-choice QA adaptation;
- `dpo/`: preference-optimization experiments;
